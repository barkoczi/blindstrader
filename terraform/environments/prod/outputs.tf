...
output "deployment_info" {
  ...
  value       = <<-EOT
    ...
    Per-service APP_KEYs:
       - /blindstrader/prod/app_key_identity
       - /blindstrader/prod/app_key_brand
       - /blindstrader/prod/app_key_supplier
       - /blindstrader/prod/app_key_supply_chain
       - /blindstrader/prod/app_key_payment
       - /blindstrader/prod/app_key_retailer
       - /blindstrader/prod/app_key_platform
       - /blindstrader/prod/app_key_notification

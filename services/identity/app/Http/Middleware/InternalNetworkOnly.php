...
class InternalNetworkOnly
{
    ...
    private function ipInRange(string $ip, string $range): bool
    {
        ...
        $isRangeIPv6 = strpos($subnet, ':') !== false;

        // Skip mismatched address families entirely
        ...
        // IPv4 — guard against invalid IPs or out-of-range mask
        $ipLong = ip2long($ip);
